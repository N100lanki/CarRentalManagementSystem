...
import com.example.TravelApplication.Mapper.CarMapper;
...
public class CarDaoImpl implements CarDao {
	...
	public void updateCar(int id, Car car) {
		...
		KeyHolder holder = new GeneratedKeyHolder();
		SqlParameterSource param = new MapSqlParameterSource().addValue("id",car.getCarId()).addValue("carmodel",car.getCarModel()).addValue("carno",car.getCarNo()).addValue("status", car.getStatus());
